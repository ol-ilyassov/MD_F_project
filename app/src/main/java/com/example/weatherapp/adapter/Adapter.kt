...
class Adapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.description.text = currentItem.weather[0].description
        ...
        holder.time.text = dateList[1].subSequence(0, 5)
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val description: TextView = itemView.weather_description_value
        ...
        val time: TextView = itemView.time_value
    }
